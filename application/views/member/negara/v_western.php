               ...
               <h2 class="title text-center">WESTERN</h2>
                ...
                <h3><span class="glyphicon glyphicon-music"></span> Artist</h3>
                    <div class="row">
                        ...
                        <div class="album">
                        <img src="<?php echo base_url();?>assets/images/lagu/1.jpg" class="img-responsive" alt="music theme" />
                        <div class="albumdetail"><h5>Crazy Freso</h5><a href="#" class="listen" data-toggle="modal" data-target="#albumdetail">
                        ...
                        <div class="col-sm-3 col-xs-12">
                        <div class="album">
                        <img src="<?php echo base_url();?>assets/images/lagu/2.jpg" class="img-responsive" alt="music theme" />
                        <div class="albumdetail"><h5>Crazy Freso</h5><a href="#" class="listen" data-toggle="modal" data-target="#albumdetail">
                        <span class="glyphicon glyphicon-headphones"></span> Listen Song</a>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-3 col-xs-12">
                        <div class="album">
                        <img src="<?php echo base_url();?>assets/images/lagu/3.jpg" class="img-responsive" alt="music theme" />
                        <div class="albumdetail"><h5>Crazy Freso</h5><a href="#" class="listen" data-toggle="modal" data-target="#albumdetail">
                        <span class="glyphicon glyphicon-headphones"></span> Listen Song</a>
                        </div>
                        </div>
                        ...
                        <div class="col-sm-3 col-xs-12">
                        <div class="album">
                        <img src="<?php echo base_url();?>assets/images/lagu/4.jpg" class="img-responsive" alt="music theme" />
                        <div class="albumdetail"><h5>Crazy Freso</h5><a href="#" class="listen" data-toggle="modal" data-target="#albumdetail">
                        <span class="glyphicon glyphicon-headphones"></span> Listen Song</a>
                        </div>
                        </div>
                ...
                <div class="modal-content">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                     <h2>New trends in music</h2>
                        <a href="#" class="thumbnail"><img src="<?php echo base_url();?>assets/images/lagu/4.jpg" class="img-reponsive" alt="blog" /></a>
                            <div class="thumbnail" class="col-lg-8 col-lg-offset-2" alt="blog">                                                                           
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                            <div class="pull-right" alt="blog">
                                <a class="fa fa-comments" data-toggle="modal" data-target="#myModal"> </a>
                            </div>
                            </div>
                ...
                <form action="#" class="form-horizontal" method="post" enctype="multipart/form-data">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="panel">
                          <img src="#" class="img-text" width="70" align="left"/>
                            <span class="contacts-title"><strong>nama</strong></span>
                            <p>komentar</p> 
                        </div>
