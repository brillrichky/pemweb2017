...
<body>
    ...
    <section>
        <div class="container">
           ...
           <h2 class="title text-center">DELETE EVENT</h2>
            ...
            <tbody>
             <?php foreach($event as $d){ ?>
              ...
              <td><p>Are you sure you Delete Event Member ?</p>
                    <div class="mb-footer">
                        <div><a href="<?php echo site_url('C_Admin/action_delete/'.$d['id_event']);?>" class="btn btn-default">Yes</a> 
                        </div>
